...
<div class="container payment_main_wrapper">
  <div class="row">
        ...
        <?php if (wp_is_mobile()) { ?>
          ...
          <ul class="accordion">
            <li>
              <a><?php echo get_post_meta( get_the_ID(), 'payment_metabox_reception_title', true ); ?></a>
              <div class="accordion_content">
                <?php echo wpautop(get_post_meta( get_the_ID(), 'payment_metabox_reception_text', true )); ?>
              </div>
            </li>
            <li>
              <a><?php echo get_post_meta( get_the_ID(), 'payment_metabox_payment_title', true ); ?></a>
              <div class="accordion_content">
                <?php echo wpautop(get_post_meta( get_the_ID(), 'payment_metabox_payment_text', true )); ?>
              </div>
            </li>
            <li>
              <a><?php echo get_post_meta( get_the_ID(), 'payment_metabox_delivery_title', true ); ?></a>
              <div class="accordion_content">
        ...
        <?php } else { ?>
          <div class="col-lg-12">
            ...
            <div class="row tabs_wrapper">
              <div class="col-lg-8 tabs_wrapper_outside">
              ...
              <div class="col-lg-4 toggles_wrapper_outside">
                <div class="tabs_wrapper_header">
                  <div id="reception_btn" class="active tab_btn">
