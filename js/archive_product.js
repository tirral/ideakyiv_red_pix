...
jQuery(document).ready(function ($) {
  ...
  $.widget("custom.rangeslider", {
    ...
    moveLabel: function () {
      ...
      $output.css("left", pixel_pos + "px").html(slider_value);
    ...
    createMessage: function (elem, msg) {
      var msg_html =
          '<span class="js-range-tooltip range-slider-message"></span>',
        self = this.element;
  ...
  $(".product_category_sitebar_list_item_wrapper").on("click", function () {
    $(".product_category_sitebar_list_item_wrapper").removeClass(
      "active_radio"
    );
